 ...
 * @version 1.0
 */
public class SimulatedAnnealingBoltzman extends OptimizationAlgorithm {
     ...
     */
    public SimulatedAnnealingBoltzman(double t, double cooling, HillClimbingProblem hcp) {
        super(hcp);
        this.t = t;
        this.initTemp = t;
